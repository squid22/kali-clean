...
sudo apt-get install -y arandr flameshot arc-theme feh i3 i3-wm lxappearance python3-pip rofi unclutter cargo polybar picom papirus-icon-theme imagemagick
